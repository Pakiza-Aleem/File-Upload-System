...
The extension endpoints are intentionally not implemented in this starter. Search for
`TODO (student extension)` comments to find the natural places to continue.
